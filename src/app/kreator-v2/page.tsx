    ...
    <div className="min-h-screen bg-white pb-28 sm:pb-32">
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-stretch sm:justify-between gap-3">
            <Button
              onClick={goToPreviousStep}
              disabled={step === 'product'}
              variant="soft"
              size="3"
              className="w-full sm:w-auto rounded-xl px-6 py-3 bg-white text-gray-800 hover:bg-gray-50 transition-all duration-200 border border-gray-200 disabled:opacity-50"
            >
            ...
            <Button
              ...
              variant="solid"
              size="3"
              className="w-full sm:w-auto rounded-xl px-6 py-3 bg-gray-800 hover:bg-black text-white transition-all duration-200 shadow-sm hover:shadow disabled:opacity-50"
            >
              {nextLabel}
